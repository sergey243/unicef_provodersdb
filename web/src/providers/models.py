...
class Provider(Model):
    ...
    subsidiaries = fields.CharField(verbose_name=_("subsidiaries/representations"),max_length=500, blank=True, null=True)
    ...
    offers_previously_provided = fields.TextField(verbose_name=_("offers previously provided"),max_length=2500, blank=True, null=True,
